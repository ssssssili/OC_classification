...
def fine_tune_bert(feature, label, model_path, pt_path, unfreeze_layers, batch_size, num_epochs, max_length, num_labels, name):
    ...
    config = BertConfig.from_pretrained(pt_path, num_labels=num_labels)
...
def train_and_evaluate_series_model(feature, label, model_type, pt_path, layer_configs, batch_size, num_epochs, max_length,
    ...
    for config_num, unfreeze_layers in enumerate(layer_configs, 1):
        ...
        evaluation_results = fine_tune_bert(feature, label, model_path=model_type, pt_path=pt_path,
