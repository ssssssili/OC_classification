...
with open("pcsindex.txt", "r", encoding="utf-8") as file:
    pcs_texts = file.readlines()
    pcs_texts = str(pcs_texts)

for layers in unfreeze_layers:
    train_bert_unsupervised(pcs_index, model_name, pcs_texts, layers)