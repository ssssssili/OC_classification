...
def train_and_save_model(index, model_type, unfrozen_layers, text_data, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        for inputs in tokenized_chunks:
            ...
            # Replace 1 with the actual label for the text data
...
model_types = ['bert-base-multilingual-uncased']
...
for model_type in model_types:
    for unfrozen_layers in layers_to_tune:
        model_save_path = train_and_save_model(index, model_type, unfrozen_layers, data, 20)
