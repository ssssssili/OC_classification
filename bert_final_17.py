...
def train(model, train_data, val_data, learning_rate, epochs):
    ...
    plt.title("ISCO68 + Plus + Bert + Unfreeze 0 layer", fontdict={'size': 20})
    plt.savefig('exp17/17_loss.png')
    ...
    plt.title("ISCO68 + Plus + Bert + Unfreeze 0 layer", fontdict={'size': 20})
    plt.savefig('exp17/17_accuracy.png')
...
def evaluate(model, test_data):
    ...
    np.savetxt('exp17/test_labels.txt', test_labels, fmt = '%f')
    np.savetxt('exp17/pred_labels.txt', pred_labels, fmt = '%f') 
