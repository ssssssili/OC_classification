...
def train(model, train_data, val_data, learning_rate, epochs):
    ...
    plt.title("ISCO68 + Original + Bert + Unfreeze 1 layer", fontdict={'size': 20})
    plt.savefig('exp13/13_loss.png')
    ...
    plt.title("ISCO68 + Original + Bert + Unfreeze 1 layer", fontdict={'size': 20})
    plt.savefig('exp13/13_accuracy.png')
...
def evaluate(model, test_data):
    ...
    np.savetxt('exp13/test_labels.txt', test_labels, fmt = '%f')
    np.savetxt('exp13/pred_labels.txt', pred_labels, fmt = '%f') 
