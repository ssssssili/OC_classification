...
print(len(pcs_short))
print(len(naf_short))
print(len(pcs_short['code_pcs'].value_counts()))
print(pcs_short['code_pcs'].value_counts())
print(len(naf_short['code_naf'].value_counts()))
print(naf_short['code_naf'].value_counts())
...
data_preprocess.PlotData(naf_short, column='code_naf')
data_preprocess.PlotData(pcs_short, column='code_pcs')
