...
def train(model, train_data, val_data, learning_rate, epochs):
    ...
    plt.title("ISCO88 + Plus + Bert + Unfreeze 1 layer", fontdict={'size': 20})
    plt.savefig('exp11/11_loss.png')
    ...
    plt.title("ISCO88 + Plus + Bert + Unfreeze 1 layer", fontdict={'size': 20})
    plt.savefig('exp11/11_accuracy.png')
...
def evaluate(model, test_data):
    ...
    np.savetxt('exp11/test_labels.txt', test_labels, fmt = '%f')
    np.savetxt('exp11/pred_labels.txt', pred_labels, fmt = '%f') 
