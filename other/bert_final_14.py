...
def train(model, train_data, val_data, learning_rate, epochs):
    ...
    plt.title("ISCO68 + Plus + Bert + Unfreeze 1 layer", fontdict={'size': 20})
    plt.savefig('exp14/14_loss.png')
    ...
    plt.title("ISCO68 + Plus + Bert + Unfreeze 1 layer", fontdict={'size': 20})
    plt.savefig('exp14/14_accuracy.png')
...
def evaluate(model, test_data):
    ...
    np.savetxt('exp14/test_labels.txt', test_labels, fmt = '%f')
    np.savetxt('exp14/pred_labels.txt', pred_labels, fmt = '%f') 
