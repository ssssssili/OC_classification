...
model1.load_state_dict(torch.load("88m_unfreeze_0_model.pt"))
...
model4.load_state_dict(torch.load("88m_unfreeze_all_model.pt"))
...
model3.load_state_dict(torch.load("88m_unfreeze_015_model.pt"))
