...
torch.save(model1.state_dict(), "naf_unfreeze_0_model.pt")
"""
"""
...
torch.save(model2.state_dict(), "naf_unfreeze_01_model.pt")
...
torch.save(model3.state_dict(), "naf_unfreeze_015_model.pt")
