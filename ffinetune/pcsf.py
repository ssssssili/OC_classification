...
pcs_data['label'] = le.fit_transform(pcs_data['code_pcs'])
data = pcs_data[['feature', 'label']]
...
torch.save(model2.state_dict(), "pcs_unfreeze_015_model.pt")
"""
"""
