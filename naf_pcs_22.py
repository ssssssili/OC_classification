...
def train(model, train_data, val_data, learning_rate, epochs):
    ...
    plt.title("NAF + Original + Bert + Unfreeze 1 layer", fontdict={'size': 20})
    plt.savefig('exp22/22_loss.png')
    ...
    plt.title("NAF + Original + Bert + Unfreeze 1 layer", fontdict={'size': 20})
    plt.savefig('exp22/22_accuracy.png')
...
def evaluate(model, test_data):
    ...
    np.savetxt('exp22/test_labels.txt', test_labels, fmt = '%f')
    np.savetxt('exp22/pred_labels.txt', pred_labels, fmt = '%f')    
